...
import cz.cuni.mff.respefo.component.RectifyPoints;
import cz.cuni.mff.respefo.listeners.MouseDragListener;
import cz.cuni.mff.respefo.listeners.MouseWheelZoomListener;
import cz.cuni.mff.respefo.listeners.RectifyKeyListener;
import cz.cuni.mff.respefo.listeners.RectifyMouseListener;
...
public class RectifyItemListener extends Function {
	...
	public void clearPoints() {
		if (!summary) {
			if (Message.question("Do you want to clear all points?")) {
